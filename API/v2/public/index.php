...
require '../app/models/entity/PistaEntity.php';
require '../app/models/DTO/PistaDTO.php';
require '../app/models/DAO/PistaDAO.php';
require '../app/models/DTO/JugadorDTO.php';
require '../app/models/entity/JugadorEntity.php';

require '../app/models/entity/ReservaEntity.php';
require '../app/models/DTO/ReservaDTO.php';
require '../app/models/DAO/ReservaDAO.php';
